...
/**
 * Strings for component 'theme_test_theme', language 'en'
 *
...
<div class="well">
<h2>test_theme</h2>
<p><img class=img-polaroid src="test_theme/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>test_theme is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="test_theme/README.txt">How to copy and customise this theme.</a></p>
</div></div>';

$string['configtitle'] = 'test_theme';
