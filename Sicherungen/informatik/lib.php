 ...
 * @return string
 */
function informatik_user_settings($css, $theme) {
    ...
    $css = informatik_set_fontsizereference($css, $fontsizereference);
    ...
    $css = informatik_set_headerbgc($css, $headerbgc);
    ...
    $css = informatik_set_blockcontentbgc($css, $blockcontentbgc);
    ...
    $css = informatik_set_lblockcolumnbgc($css, $lblockcolumnbgc);
    ...
    $css = informatik_set_rblockcolumnbgc($css, $rblockcolumnbgc);
    ...
    $css = informatik_set_blockcolumnwidth($css, $blockcolumnwidth);
    ...
    $css = informatik_set_customcss($css, $customcss);
 ...
 *
 */
function informatik_set_fontsizereference($css, $fontsizereference) {
    $tag = '[[setting:fontsizereference]]';
    $css = str_replace($tag, $fontsizereference.'px', $css);
    return $css;
}

function informatik_set_headerbgc($css, $headerbgc) {
    $tag = '[[setting:headerbgc]]';
    $css = str_replace($tag, $headerbgc, $css);
    return $css;
}

function informatik_set_blockcontentbgc($css, $blockcontentbgc) {
    $tag = '[[setting:blockcontentbgc]]';
    $css = str_replace($tag, $blockcontentbgc, $css);
    return $css;
}

function informatik_set_lblockcolumnbgc($css, $lblockcolumnbgc) {
    $tag = '[[setting:lblockcolumnbgc]]';
    $css = str_replace($tag, $lblockcolumnbgc, $css);
    return $css;
}

function informatik_set_rblockcolumnbgc($css, $rblockcolumnbgc) {
    $tag = '[[setting:rblockcolumnbgc]]';
    $css = str_replace($tag, $rblockcolumnbgc, $css);
    return $css;
}

function informatik_set_blockcolumnwidth($css, $blockcolumnwidth) {
...
function informatik_set_customcss($css, $customcss) {
