...
/**
 * Strings for component 'theme_informatik', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_informatik
...
<div class="clearfix">
    <div class="theme_screenshot">
        <h2>Informatik</h2>
        <img src="informatik/pix/screenshot.gif" />
    ...
    <div class="theme_description">
        <h2>About</h2>
        <p>Informatik is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
        <h2>Tweaks</h2>
...
$string['configtitle'] = 'Informatik theme';
...
$string['noframe'] = 'Informatik 1.9 look';
